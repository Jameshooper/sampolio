...
const KEYWORDS: Array<[RegExp, string]> = [
  ...
  [/electric|sähkö|water|vesi|heating|gas bill|internet|broadband|phone|puhelin|dna|elisa|telia/i, 'Utilities'],
  [/bus|train|hsl|vr\b|metro|fuel|bensa|diesel|parking|taxi|uber|bolt|car\b|auto\b/i, 'Transportation'],
  [/grocer|market|prisma|k-market|s-market|lidl|alepa|sale\b|food|ruoka|restaurant|ravintola|lunch|lounas|wolt|foodora/i, 'Food & Groceries'],
  [/doctor|lääkäri|pharmacy|apteekki|dentist|hammas|terveys|hospital/i, 'Healthcare'],
  ...
  [/amazon|zalando|ikea|clothes|vaate|shopping|verkkokauppa|gigantti/i, 'Shopping'],
